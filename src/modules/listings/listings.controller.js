...
var ListingsController = function () {
    var _classDecorators = [(0, common_1.Controller)('listings')];
    ...
    var ListingsController = _classThis = /** @class */ (function () {
        function ListingsController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        ListingsController_1.prototype.getAll = function () {
        ...
        ListingsController_1.prototype.getOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.service.findOne(id)];
                });
            });
        };
        ListingsController_1.prototype.create = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    // هنا تقدر تضيف Validation أو Authentication لاحقًا
                    return [2 /*return*/, this.service.create(body)];
                });
            });
        };
        ListingsController_1.prototype.remove = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
